...
$2012R2Vhd = '<PATH TO SERVER 2012 R2 ISO>'
$AADTenantDomain = '<AAD DOMAIN FQDN>'  # example myazurestacklab.onmicrosoft.com
$ServiceAdminUsername = '<AAD SERVICE ADMIN>'  # example serviceadmin@myazurestacklab.onmicrosoft.com
$ServiceAdminPassword = '<AAD SERVICE ADMIN PASSWORD>'
$TenantUserName = '<AAD TENANT ADMIN>' #example Tenant@myazurestacklab.onmicrosoft.com
$TenantPassword = '<AAD TENANT ADMIN PWD>'
$AzureAD = "<BILLING DOMAIN FQDN>"
$AzureSubID = "<BILLING DOMAIN SUBSCRIPTION ID>"
$UserAccountName = "<BILLING DOMAIN SUBSCRIPTION OWNER>"
$MASDomain ='<AZURE STACK DOMAIN NAME>' #example azurestack.external
$RegionName='<AZURE STACK REGION NAME>' #example local
...
$SubscriptionId = '<SERVICE ADMIN TENANT SUBSCRIPTION ID>'
...
invoke-webrequest <PATH TO FILES>3 -OutFile "C:\Temp\<FILENAME>"
cd C:\Temp
expand-archive <FILENAME> -DestinationPath .\<FILENAME> -Force
del <FILENAME> -Force
